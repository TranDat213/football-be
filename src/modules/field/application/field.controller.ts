...
export class FieldController{
    ...
    async createField(req: Request, res:Response, _next:NextFunction) {
        ...
        return res.status(201).json({ message: "Field created successfully", data: field });
    }
